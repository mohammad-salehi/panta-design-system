    ...
    <div>
      ...
      <div>
        ...
        <aside
          ...
          // دیگر نیازی به stopPropagation نیست
        >
          {/* هدر سایدبار موبایل */}
          <div className="flex items-center justify-between p-4 border-b border-boxBorderColor">
            <div className="flex items-center gap-2">
              {brand ? (
                brand
              ) : (
                <div className="font-bold text-titleText">لوگو</div>
              )}
          ...
          {/* کارت کاربر موبایل */}
          <div className="p-4 border-b border-boxBorderColor lux-btn m-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                <div className="text-sm font-semibold text-titleText">
                  {userFullName}
                </div>
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-2">
            {navItems.map((item) => {
              ...
              return (
                <a href={item.link} key={item.label} className="block">
                  <button
                    type="button"
                    className={clsx(
                      "w-full flex items-center justify-between gap-1 px-1 py-1 rounded-xl transition lux-icon cursor-pointer",
                      isActive
                        ? "bg-primary/20 dark:bg-gray-700/70"
                        : "hover:bg-primary/10 dark:hover:bg-gray-800/50"
                    )}
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <span
                        className={clsx(
                          ...
                          isActive
                            ? "text-primary border-primary bg-primary/10 dark:bg-gray-700"
                            : "text-titleText border-boxBorderColor"
                        )}
                      >
                        {item.icon}
                      </span>
                      <span
                        className={clsx(
                          ...
                          isActive
                            ? "text-primary font-semibold dark:text-gray-200"
                            : "lux-text hover:text-primary dark:hover:text-gray-300"
                        )}
                        dir="rtl"
                      >
                        {item.label}
                    ...
                    <svg
                      ...
                      className={clsx(
                        ...
                        isActive
                          ? "opacity-100 text-primary dark:text-gray-300"
                          : "opacity-40"
                      )}
                    >
                      <path
          ...
          {/* دکمه خروج موبایل */}
          {onLogout && (
            <div className="p-4 border-t border-boxBorderColor">
              <button
                onClick={onLogout}
      ...
      >
        {/* Sidebar header */}
        <div className="sticky top-0 z-10  rounded-none border-none">
          <div className="p-3">
            ...
            <div className="mt-3 rounded-2xl border border-boxBorderColor bg-boxColor/70 p-3 lux-icon">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl flex items-center justify-center  lux-btn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
                      stroke="currentColor"
                ...
                <div className="min-w-0 flex-1" dir="ltr">
                  <div className="text-sm font-semibold truncate lux-text">
                    {userFullName}
                  </div>
                  <div className="text-[11px] text-gray-500 truncate lux-text">
                    {userRole}
                  </div>
                </div>
                {onChangePassword && (
              ...
              >
                <button
                  ...
                  className={clsx(
                    "w-full flex items-center justify-between gap-1 px-1 py-1 rounded-xl transition lux-icon cursor-pointer",
                    isActive
                      ? "bg-primary/20 dark:bg-gray-700/70" // اکتیو: پررنگ‌تر
                      : "hover:bg-primary/10 dark:hover:bg-gray-800/50" // هاور: ملایم‌تر
                  )}
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <span
